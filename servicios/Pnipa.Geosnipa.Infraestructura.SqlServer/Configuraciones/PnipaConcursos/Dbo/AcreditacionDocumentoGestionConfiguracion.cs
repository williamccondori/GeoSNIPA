...
public class AcreditacionDocumentoGestionConfiguracion : IEntityTypeConfiguration<AcreditacionDocumentoGestionEntidad>
{
    public void Configure(EntityTypeBuilder<AcreditacionDocumentoGestionEntidad> builder)
    {
        builder.HasKey(p => new { p.Id });
        builder.ToTable("AcreditacionDocumentoGestion", "dbo");
