namespace Pnipa.Geosnipa.Dominio.Entidades.Geosnipa;
...
public class SubProyectoEntidad
{
    ...
    public string? TituloSubproyecto { get; init; }
    ...
    public string? EslabonCadena { get; init; }
    public string? Especies { get; init; }
    public string? Usuario { get; init; }
    public string? EntidadProponente { get; init; }
    public string? EstadoEjecucion { get; init; }
    ...
    public string? TipoEntidadParticipa { get; init; }
    public string? BeneficioAmbiental { get; init; }
    public string? TemaAmbiental { get; init; }
    public string? BeneficioSocial { get; init; }
    ...
    public string? SubProyectoEmblematico { get; init; }
    public string? LinkFicha { get; init; }
    public string? HambreCero { get; init; }
}