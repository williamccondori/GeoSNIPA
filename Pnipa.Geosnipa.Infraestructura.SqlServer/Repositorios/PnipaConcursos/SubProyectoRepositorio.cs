        ...
        public async Task<IEnumerable<ReporteParaGeoVisorModelo>> ObtenerReporteParaGeoVisor()
        {
            ...
            var aportes = await (
                ...
                group new
                {
                    ...
                    entidad,
                    presupuestoEntidad
                } by new { postulante.Id } into agrupador
            ...
            var desembolsos = await (
                ...
                join pasoCriticoResumen in (
                    ...
                    group new { pasoCritico, cronogramaPoaFinanciera } by new
                    {
                        pasoCritico.Id
                    } into agrupador
            ...
            return (
                ...
                join vigencia in vigencias
                    on new
                    {
                        subProyecto.PostulanteId,
                        CodigoEnvioProyecto = subProyecto.CodigoSubProyecto
                    } equals new { vigencia.PostulanteId, vigencia.CodigoEnvioProyecto }
