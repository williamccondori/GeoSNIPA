...
{
    public class TemaFactorCriticoConfiguracion
        : IEntityTypeConfiguration<TemaFactorProyectoCritico>
    {
        public void Configure(EntityTypeBuilder<TemaFactorProyectoCritico> builder)
        {
