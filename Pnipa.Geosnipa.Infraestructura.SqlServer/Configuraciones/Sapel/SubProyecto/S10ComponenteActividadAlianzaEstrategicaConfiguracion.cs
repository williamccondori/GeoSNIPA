...
public class
    S10ComponenteActividadAlianzaEstrategicaConfiguracion : IEntityTypeConfiguration<
        S10ComponenteActividadAlianzaEstrategicaEntidad>
{
    public void Configure(EntityTypeBuilder<S10ComponenteActividadAlianzaEstrategicaEntidad> builder)
    {
        ...
        builder.Property(p => p.ComponenteActividadAlianzaEstrategicaId)
            .HasColumnName("COMPONENTEACTIVIDADALIANZAESTRATEGICA_ID").IsRequired();
        builder.Property(p => p.ComponenteActividadId).HasColumnName("COMPONENTEACTIVIDAD_ID").IsRequired();
