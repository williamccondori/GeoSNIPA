...
public class SubProyectoConfiguracion : IEntityTypeConfiguration<SubProyectoEntidad>
{
    public void Configure(EntityTypeBuilder<SubProyectoEntidad> builder)
    {
        ...
        builder.Property(p => p.S1TmDetalleDescripcionEslabon).HasColumnName("S1TMDET_DESC_ESLABON");
        ...
        builder.Property(p => p.S9CantidadAgentesProductivosHombres).HasColumnName("S9CANTAGENTESPRODUCTIVOSHOMBRES");
        builder.Property(p => p.S9CantidadAgentesProductivosMujeres).HasColumnName("S9CANTAGENTESPRODUCTIVOSMUJERES");
        builder.Property(p => p.S9CantidadAgentesInnovacionHombres).HasColumnName("S9CANTAGENTESINNOVACIONHOMBRES");
        builder.Property(p => p.S9CantidadAgentesInnovacionMujeres).HasColumnName("S9CANTAGENTESINNOVACIONMUJERES");
