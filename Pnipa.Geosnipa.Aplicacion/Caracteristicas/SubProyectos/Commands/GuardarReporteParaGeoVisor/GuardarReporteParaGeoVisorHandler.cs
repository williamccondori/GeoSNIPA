...
{
    public class GuardarReporteParaGeoVisorHandler
        : IRequestHandler<GuardarReporteParaGeoVisorRequest, GuardarReporteParaGeoVisorResponse>
    {
        ...
        public async Task<GuardarReporteParaGeoVisorResponse> Handle(
            GuardarReporteParaGeoVisorRequest request,
        ...
        )
        {
            ...
            return new GuardarReporteParaGeoVisorResponse
            {
                TotalSubProyectos = subProyectos.Count()
            };
        }
    }
}
